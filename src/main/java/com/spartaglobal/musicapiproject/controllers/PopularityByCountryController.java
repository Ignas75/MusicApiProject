...
public class PopularityByCountryController {
    ...
    public ResponseEntity<?> getAlbumPopularityByBillingCountry(@RequestParam String country, @RequestParam int numRecords, @RequestParam String sortType){
    ...
    public ResponseEntity<?> getArtistPopularityByBillingCountry(@RequestParam String country, @RequestParam int numRecords, @RequestParam String sortType){
        if (sortType.equals("DESC")){
    ...
    public ResponseEntity<?> getGenrePopularityByBillingCountry(@RequestParam String country, @RequestParam int numRecords, @RequestParam String sortType){
        if (sortType.equals("DESC")){
    ...
    public ResponseEntity<?> getPlaylistPopularityByBillingCountry(@RequestParam String country, @RequestParam int numRecords, @RequestParam String sortType){
        if (sortType.equals("DESC")){
    ...
    public ResponseEntity<?> getTrackPopularityByBillingCountry(@RequestParam String country, @RequestParam int numRecords, @RequestParam String sortType){
        if (sortType.equals("DESC")){
